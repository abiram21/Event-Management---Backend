...
use App\Http\Requests\ShortEatUpdateRequest;
...
class ShorteatsController extends Controller
{
    ...
    public function index()
    {
            ...
            return ShorteatsResource::collection($shorteats->paginate(1000));
    ...
    public function show($id)
    {
            ...
            $shorteats = Shorteats::with('client')->find($id);
            return new ShorteatsResource($shorteats);
    }
    ...
    {
        $clients = Shorteats::where('type', $type)->where('minQty','<',$qty)->where('maxQty','>=',$qty)->with('client')->orderBy('unit_price')->paginate(1000);
