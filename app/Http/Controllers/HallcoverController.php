...
class HallcoverController extends Controller
{
    ...
    public function index()
    {
            ...
            return HallCoverResource::collection($hallcover->paginate(1000));
    ...
    public function show( $id)
    {
        ...
        $hallcover = Hallcover::with('client')->find($id);
        return new HallcoverResource($hallcover);
    }
    ...
    {
            $clients = Hallcover::where('hall_size',$size)->with('client')->orderBy('price')->paginate(1000);
